...
MIGRATION_FILE="supabase/migrations/20251020_fix_critical_rls_vulnerabilities_v2.sql"
...
cat supabase/migrations/20251020_fix_critical_rls_vulnerabilities_v2.sql
